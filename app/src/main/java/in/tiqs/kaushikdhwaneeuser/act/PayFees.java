...
public class PayFees extends AppCompatActivity  {
    ...
    TextView header,pfb_tamt,pfb_payamt,terms_con;
    LayoutInflater inflater;
    HashMap<String, String> paramMap = new HashMap<String, String>();
    String [] months={"Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"};
    String strCardType="",strPaymentMode="",UserId = "", dt = "", url = "", WUrl = "", OrderId="", Amount="", Response="";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        payment_mode=(TabLayout) findViewById(R.id.payment_mode);
        type=(TabLayout) findViewById(R.id.type);
        terms_con=(TextView)findViewById(R.id.terms_con);
        ...
        terms_con.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PayFees.this, Terms_Condicctions.class));
            }
        });
                        ...
                        if (jsonObject.getInt("success") == 1)
                        {
                            ...
                            for (int i=0;i<jsonObject.length()-2;i++)
                            {
                                ...
                                amounts.add(jsonObject1.getString("balance_amount"));
                                  Log.e("abc",jsonObject1.getString("balance_amount"));
                                ...
                                {
                                    TextView tv1 = (TextView) v.findViewById(R.id.wdfs_name);
                                    tv1.setText( months[Integer.parseInt(jsonObject1.getString("invoice_date"))-1]+"");
...

                                {
                                    try
                                    {
                                        if (!pfb_tamt.getText().toString().equals("0"))
                                        {
                                                ...
                                                Intent newPayIntent = new Intent(PayFees.this, PayActivity.class);
                                             ...
                                             newPayIntent.putExtra("customerMobileNo", new DataBase_Helper(PayFees.this).getUserMobileNumber("1"));
                                ...
                                public void onTransactionResponse(Bundle bundle)
                                {
                                    ...
                                    if (RESPCODE.equals("01"))
                                    {
                                        try
                                        {
                                            ...
                                            jo.put("user_id", new DataBase_Helper(PayFees.this).getUserId("1"));
    ...
    public   void onActivityResult(int requestCode, int resultCode, Intent data)
    {
            ...
            if (data != null)
        {
            ...
            if(resKey!=null && resValue!=null)
            {
                ...
                {
                    SharedPreferences member_datails=getSharedPreferences("member_datails", Context.MODE_PRIVATE);
                    jsonObject.put("user_id", new DataBase_Helper(PayFees.this).getUserId("1"));
                    jsonObject.put("total_amount",pfb_tamt.getText().toString().trim());
                    jsonObject.put("final_amount", pfb_payamt.getText().toString().trim());
