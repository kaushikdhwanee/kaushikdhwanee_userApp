package in.tiqs.kaushikdhwaneeuser.data_base;
...
public class DataBase_Helper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "kaushikdhwanee";
    private static final String TABLE_CONTENTS = "kaushikdhwanee";
