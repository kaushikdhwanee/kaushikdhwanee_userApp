   ...
   static Context context;
    ...
    public void setCustomBackground(Drawable drawable) {
        if (drawable == null) {
          ...
          //  this.customBackground = new ColorDrawable(Color.GRAY);
    ...
    private void setEnabled() {
        ...
        setVisibility(shouldBeVisible ? View.VISIBLE : View.VISIBLE);
    }
    ...
    private static Drawable generateBackground(int color, int fadeTime) {
      ...
      //  drawable.addState(new int[]{android.R.attr.state_checked}, generateCircleDrawable(color));
        ...
        Drawable dr = ContextCompat.getDrawable(context,R.drawable.cborder_lib);

        drawable.addState(new int[]{}, dr);

      //  drawable.addState(new int[]{}, generateRectangleDrawable(Color.parseColor("#dbdbdb")));
    ...
    private static Drawable generateRectangleDrawable(final int color) {
      ...
      //  drawable.getPaint().set
      //  drawable.getPaint().setStrokeWidth(2);
        drawable.setShaderFactory(new ShapeDrawable.ShaderFactory() {
            @Override
            public Shader resize(int width, int height) {
                return new LinearGradient(5, 5, 5, 5, color, color, Shader.TileMode.REPEAT);
            }
        });
        return drawable;
    }
    ...
    private static Drawable generateRippleDrawable(final int color) {
        ...
        Drawable mask = generateCircleDrawable(Color.TRANSPARENT);
