...
//                dayView.setLayoutParams(params);
    ...
    public void onClick(View v) {
        if (v instanceof DayView) {
           ...
           // Toast.makeText(con,String.valueOf(dayView.getDate()), Toast.LENGTH_LONG).show();
            String str=String.valueOf(dayView.getDate());
            String st=str.substring(str.indexOf("{") + 1, str.indexOf("}"));
            String sp[]=st.split("-");
            switch(sp[1])
            {
                case "01":
