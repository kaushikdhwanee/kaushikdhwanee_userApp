...
//        );
        ...
        titleChanger = new TitleChanger(title,context,attrs);
...
title.setTextColor(calendarTitleColor);
    ...
    topbar.setBackgroundColor(Color.parseColor("#00aeef"));
    ...
    public void setMinimumDate(@Nullable CalendarDay calendar) {
        minDate = calendar;
        adapter.setDateSelected(minDate,true);
        dispatchOnDateSelected(minDate,true);
